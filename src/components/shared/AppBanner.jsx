...
const AppBanner = () => {
  ...
  return (
    <motion.section
      ...
      className='flex flex-col sm:justify-between items-center sm:flex-col pt-10 md:pt-32 border-2 border-red-600 border-solid relative overflow-hidden '
    >
        <motion.div
          initial={{ opacity: 0, y: -180 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ ease: 'easeInOut', duration: 0.9, delay: 0.2 }}
          className="mx-auto w-[300px] h-[300px] sm:w-[300px] sm:h-[300px] sm:mt-0 border-2 border-red-600 border-solid bg-[url('../images/batik.jpg')] bg-cover bg-center rounded-full flex justify-center  items-center z-20 relative"
        >
        ...
        <p className='text-3xl'>
          👋 <span className='font-general-semibold text-2xl lg:text-3xl xl:text-2xl  pr-4  bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-green-600    dark:from-blue-200 dark:to-green-200'>Hi, My Name is </span>
        </p>
