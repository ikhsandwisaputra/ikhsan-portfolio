...
const ResumeCardCertif = ({title,subTitle,result,des,url}) => {
  return (
    <div className="w-full h-1/3 group flex">
      <div className="w-10 h-[6px] bg-blue-900 bg-opacity-80 mt-16 relative dark:bg-ternary-dark">
      ...
      <div className="w-full dark:bg-ternary-dark rounded-lg p-4 lgl:px-10 flex flex-col justify-center gap-6 lgl:gap-10 border-2 dark:border-none">
        <div className="flex flex-col lgl:flex-row justify-between gap-4 lgl:gap-0 lgl:items-center">
          ...
          <div>
            ...
            <div className=" md:w-[400px] md:h-[300px] mx-auto mt-5">
              <img src={url} alt="sertifikat" className="w-full h-full " />
              </div>
          </div>
        </div>
...
export default ResumeCardCertif